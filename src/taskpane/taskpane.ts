...
Office.onReady((info) => {
    if (info.host === Office.HostType.PowerPoint) {
        ...
        // Logo dropdown menu listeners
        document.getElementById("logos-with-text").onclick = () =>
            document.getElementById("logos-with-text-dropdown").classList.toggle("show");
        document.getElementById("logos-without-text").onclick = () =>
            document.getElementById("logos-without-text-dropdown").classList.toggle("show");
        ...
        document.onclick = (event) => {
            ...
            for (i = 0; i < dropdowns.length; i++) {
                ...
                if (openDropdown.classList.contains("show")
                    && event.target != document.getElementById("logos-with-text")
                    && event.target != document.getElementById("logos-without-text")) {
